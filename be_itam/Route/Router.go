...
func NewRouter(c *fiber.App) {
	...
	c.Get("/api/approval", assetController.FindApproval)
	c.Get("/api/approval/:assetId", assetController.FindDetailAsset)
	c.Patch("/api/approval", assetController.Approval)
